...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private TextView mIvFolderArrow;
    ...
    private void findViews() {
        ...
        mIvFolderArrow = (TextView) findViewById(R.id.iv_folder_arrow);
    ...
    public void onClick(View v) {
        ...
        if ( id == R.id.iv_folder_arrow) {
            ...
            takePhotoAction();
        } else if ( id == R.id.ll_title || id == R.id.iv_back ) {
           /* if ( mLlFolderPanel.getVisibility() == View.VISIBLE ) {
    ...
    private void folderItemClick(int position) {
        ...
        mIvFolderArrow.setText(photoFolderInfo.getFolderName());
    ...
    private void photoItemClick(View view, int position) {
        ...
        if (holder != null) {
            if (checked) {
                holder.mIvCheck.setImageResource(GalleryFinal.getGalleryTheme().getIconCheckDrawable());
                //holder.mIvCheck.setBackgroundColor(GalleryFinal.getGalleryTheme().getCheckSelectedColor());
            } else {
                holder.mIvCheck.setImageResource(GalleryFinal.getGalleryTheme().getIconUnCheckDrawable());
