...
public class ThemeConfig implements Serializable{
    ...
    private int iconCheckDrawable;
    private int iconUnCheckDrawable;

    private ThemeConfig(Builder builder) {
        this.iconCheckDrawable = builder.iconCheckDrawable;
        this.iconUnCheckDrawable = builder.iconUnCheckDrawable;
    ...
    public static class Builder {
        ...
        private int iconCheckDrawable = R.drawable.xuanzehou;
        private int iconUnCheckDrawable = R.drawable.xuanzeqian;

        private Drawable bgEditTexture;
        private Drawable bgPreveiw;

        public Builder setIconCheckDrawable(int iconCheckDrawable) {
            this.iconCheckDrawable = iconCheckDrawable;
            return this;
        }

        public Builder setIconUnCheckDrawable(int iconUnCheckDrawable) {
            this.iconUnCheckDrawable = iconUnCheckDrawable;
            return this;
        }
    ...
    public int getIconCheckDrawable() {
        return iconCheckDrawable;
    }

    public int getIconUnCheckDrawable() {
        return iconUnCheckDrawable;
    }
